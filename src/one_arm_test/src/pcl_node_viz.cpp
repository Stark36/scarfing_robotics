...
// Topics
static const std::string IMAGE_TOPIC = "arm1_camera1/depth/points";
...
int main (int argc, char** argv){
	...
	ros::init (argc, argv, "pcl_node_viz");
	ros::NodeHandle nh;
...
void cloud_cb(const sensor_msgs::PointCloud2ConstPtr& cloud_msg){
	...
	try{
		transformStamped = tfBuffer.lookupTransform("world", "arm1_camera_depth_optical_frame", ros::Time(0));
